...
go build -ldflags="-w -s -H windowsgui -r TaniumClock.rc" -o bin/WinAMD64/

Copy-Item bin/WinAMD64/TaniumClock.exe .\TaniumClock.exe

& 'C:\Program Files (x86)\Inno Setup 6\ISCC.exe' .\Inno\TaniumClock.iss
