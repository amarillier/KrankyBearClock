...
echo "KrankyBear Clock - Windows Sync, Compile. Package and Sync Back (bash)"
echo "================================================"
echo
...
rm -f KrankyBearClock-windows.exe
rm -f bin/*
rm -f installers/*
...
# ./setIcon.sh Resources/Images/KrankyBearHogwartsSorting.png bin/KrankyBearClock-windows.exe
